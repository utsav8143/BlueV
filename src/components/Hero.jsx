...
<div className="relative z-20 lg:top-44 lg:ms-34 lg:w-1/2 top-30 ms-10 sm:me-10">
  ...
  <p className="lg:mt-10 mt-7 font-bold text-blue-900 lg:text-xl">BlueV brings you 100% pure, healthy and refreshing drinking water, purified through advanced technology and packed with care.</p>
</div>
<div className="relative lg:top-55 lg:ms-34 top-35 ms-10 flex lg:gap-3  z-20">
...
<div className="relative flex lg:top-62 gap-10 lg:ms-34 z-20 top-40 ms-10">
